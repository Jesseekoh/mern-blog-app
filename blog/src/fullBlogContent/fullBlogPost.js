...
const FullBlogPostUi = () => {
  return (
   <div className='blog-content-div'>
      ...
      <div className='blog-content-div'>
        <p>Introduction
Microsoft Visual Studio besides being a great IDE provides the ability to customize the working environment. Most developers tend to stop customizing at the theme, dark, light or a third party theme along font size</p>
      </div>
    </div>
  );
}
